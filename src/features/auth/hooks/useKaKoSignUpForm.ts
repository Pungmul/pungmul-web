...
import { fullSignUpSchema, FullSignUpFormData, PersonalFormData } from "../types/kakao-sign-up.schemas";
import { useKakaoSignUpRequest } from "../api/kakaoSignUpApi";
...
export const useSignUpForm = () => {
  ...
  const validateCurrentStep = useCallback(async () => {
    const isValid = await kakaoValidateStep(currentStep, form, usingTermAgree, personalInfoAgree);
    return isValid;
