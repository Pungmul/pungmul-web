...
export default function ChatList() {
  ...
  return (
    <div className="flex flex-col h-full lg:w-[360px] md:border-r md:border-gray-200 w-full">
      <div
      ...
      {isSearching && (
        <div className="flex flex-row items-center justify-between px-[12px] py-[12px] bg-[#EEEEEE] w-full">
