...
export default function LightningPage() {
  ...
  return (
    <AnimatePresence mode="sync" key={"main-animate-presence"}>
      ...
      >
        {(isLoading || isParticipationLoading) && !userPartinLightning && (
      ...
      <Responsive
        mobile={
          userPartinLightning &&
          !userPartinLightning.participationStatus && <LightningOverlay />
        }
        desktop={
          userPartinLightning &&
          !userPartinLightning.participationStatus && <LightningModal />
        }
      />
    </AnimatePresence>
  );
