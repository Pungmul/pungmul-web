...
import { postComment } from "@pThunder/api/commnet/postComment";
import { postReply } from "@pThunder/api/commnet/postReply";
  ...
  const CommentHandler = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        const data = (await postComment(postId, comment)) as Comment;
  ...
  const ReplyHandler = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        const data = await postReply(postId, comment, isReplying.commentId);
            ...
            >
              <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row items-center">
                  <div
                    className="w-8 h-4 bg-blue-500 cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  ></div>
                  <div
                    className="w-8 h-4 bg-red-500 cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
