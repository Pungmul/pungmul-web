...
import { LightningCard } from "@pThunder/component/lightning/LightningCard";
import { useRouter } from "next/navigation";
import SockJS from "sockjs-client";
import { Client } from "@stomp/stompjs";
import { AddLightningCard } from "@pThunder/component/lightning/AddLightningCard";
    ...
    <div className="flex flex-col h-full w-full">
      <div className="relative w-full h-full flex-grow flex flex-col">
        ...
        <div id="map" className="relative flex-grow w-full mb-56 h-full">
          {!isLoading && (
            <div
              className="absolute w-12 h-12 flex items-center justify-center cursor-pointer shadow-lg z-10 rounded-full bottom-12 bg-white right-4"
        ...
        <div className="absolute z-10 bottom-0 w-full h-64 rounded-xl shadow-up-md bg-white overflow-hidden flex flex-col">
          <div className="mx-4 my-4 text-lg font-semibold">
