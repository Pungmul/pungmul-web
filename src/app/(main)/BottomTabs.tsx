...
export default function BottomTabs() {
    ...
    return (
        <div className="w-full justify-between bg-white flex-shrink-0 flex flex-row bottom-0 items-center sticky" style={{ height: 84, padding: '12px 32px 24px 32px' }}>
            ...
            {/* home page button */}
            <Link href={'/home'} className="w-12 h-12 justify-center items-center cursor-pointer flex">
            ...
            {/* board page button */}
            <Link href={'/board/main'} className="w-12 h-12 justify-center items-center cursor-pointer flex">
                {pathname == '/board/main' ? <Image src={BoardIconFilled} width={36} alt="" /> : <Image src={BoardIconOutline} width={36} alt="" />}
            </Link>
            {/* chat page button */}
            <Link  href={'/chats'} className="w-12 h-12 justify-center items-center cursor-pointer flex">
