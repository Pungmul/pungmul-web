...
import { formatRelativeDate } from "@pThunder/lib/shared/parseDateString";
    ...
    const createChatRoomRequest = async () => {
      try {
        const response = await createChatRoom({
          receiverName: "user10@example.com",
        });

        const { isCreated, roomUUID } = response;
    ...
    >
      ...
      >
        ...
        {room.profileImageUrl && (
          <Image src={room.profileImageUrl} alt=""></Image>
        )}
      </div>
